			...
			<li class="dropdown user"><a href="#" class="dropdown-toggle"
				...
				<ul class="dropdown-menu" role="menu">
					...
					<li role="presentation"><a
						href="<c:url value='/j_spring_security_logout'/>" class=""><i
	...
	<div class="main">
		...
		<div class="sidebar-wrapper">
			...
			<ul class="nav nav-list">
				...
				<li><a href="<c:url value='admin_timetable'/>"> <span
						class="icon"><i class="icon20 icon20 i-calendar"></i></span> <span
						class="txt">Timetable</span>
				</a></li>
				<li id="articlesTab"><a href="#"> <span class="icon"><i
							class="icon20 i-stack-list"></i></span> <span class="txt">Articles</span>
				</a>
					<ul class="sub">
						<li><a href="<c:url value='create_article'/>"> <span
								class="icon"><i class="icon20 i-stack-plus"></i></span> <span
								class="txt">Add new</span>
						</a></li>
						<li><a href="<c:url value='articles'/>"> <span
								class="icon"><i class="icon20 i-stack-list"></i></span> <span
								class="txt">All articles</span>
						</a></li>
					</ul></li>
				<li><a href="<c:url value='filemanager'/>"> <span
						class="icon"><i class="icon20 i-cloud-upload"></i></span> <span
						class="txt">Media library</span>
				</a></li>
				<li><a href="#"> <span class="icon"><i
							class="icon20 i-cart-6"></i></span> <span class="txt">Online Shop</span>
				</a></li>
				<li id="usersTab"><a href="#"> <span class="icon"><i
							class="icon20 i-users"></i></span> <span class="txt">Users</span>
				</a>
					<ul class="sub">
						<li><a href="<c:url value='admin_create_user'/>"> <span
								class="icon"><i class="icon20 i-user-plus"></i></span> <span
								class="txt">Add new</span>
						</a></li>
						<li><a href='<spring:url value="/users"></spring:url>'> <span class="icon"><i
									class="icon20 i-users"></i></span> <span class="txt">All customers</span>
						</a></li>
					</ul></li>
				<li><a href="#"> <span class="icon"><i
