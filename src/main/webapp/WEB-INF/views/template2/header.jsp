	...
	<div class="container">
		...
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="http://www.jssor.com/index.html">My bank...</a> -->
			</div>
			<div id="navbar" class="navbar-collapse collapse">
				
				<ul class="nav navbar-nav pull-left">
					<li><a href='<spring:url value="#"></spring:url>'><img alt="" class="img-circle"
							src="<%=request.getContextPath()%>/resources/images/bank.jpg" width="150" height="100"></a></li>
