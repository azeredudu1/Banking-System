...
public class SendToEmail1 {
    ...
    public SendToEmail1( String subject, User user, double amount, String codeCompte, String codeCompte2,
            String currency, String baseUrl ) {
        String text = "Hi " + user.getFirstName() + " " + user.getLastName() + ", \n \n";
        text += "you have transfered  an amount of " + amount + " " + currency + " from this account number:  "
                + codeCompte
